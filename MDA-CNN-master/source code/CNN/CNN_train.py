...
def parse_args():
    ...
    parser.add_argument('--input_disease_miRNA', nargs='?', default='/Users/qiangdanlei/Desktop/graduate thesis/MDA-CNN-master/data/CNN/disease-miro-1024-sigmoid.csv',
                        help='Input disease_gene_relationship file')

    parser.add_argument('--input_label',nargs = '?',default='/Users/qiangdanlei/Desktop/graduate thesis/MDA-CNN-master/data/CNN/label.csv',
                        help='sample label')
    ...
    parser.add_argument('--test_percentage', nargs='?', default=0.2,
                        help='percentage of test samples')
    parser.add_argument('--dev_percentage', nargs='?', default=0.2,
