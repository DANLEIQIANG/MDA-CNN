...
file_path = '/Users/qiangdanlei/Desktop/graduate thesis/MDA-CNN-master/data/regression/'
#将geneList加载进来
...
geneSimMat = pickle.load(fGeneSim,encoding='bytes')
...
fRegGeneSim = open(file_path +'regGeneSim.txt', 'r')
...
#计算miRNA和gene之间的相关关系
fGeneMirCorre = open(file_path +'geneMirCorre.txt', 'w')
